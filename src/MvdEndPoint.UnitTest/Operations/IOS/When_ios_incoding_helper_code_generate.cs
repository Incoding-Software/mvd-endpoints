namespace MvdEndPoint.UnitTest
{
    ...
    public class When_ios_incoding_helper_code_generate
    {
        ...
        static void Verify(FileOfIos file)
        {
            ...
            string expected = File.ReadAllText(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Sample_Code_Generate",  typeof(When_ios_incoding_helper_code_generate).Name + "_" + file.ToString().ToUpper()));
