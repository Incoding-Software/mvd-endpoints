                    ...
                    .StubQuery(Pleasure.Generator.Invent<GetPropertiesQuery>(dsl => dsl.Tuning(r => r.Device, DeviceOfType.Ios)
                                                                                               .Tuning(r => r.Type, typeof(GetCustomerQuery.Response))), withoutProperties ? new List<GetPropertiesQuery.Response>()
                                                                                                                                                                 : new List<GetPropertiesQuery.Response>
                                                                                                                                                                   {
                                                                                                                                                                           new GetPropertiesQuery.Response { Name = "Title", Type = ConvertCSharpTypeToIosQuery.String }, 
                                                                                                                                                                           new GetPropertiesQuery.Response { Name = "Number", Type = ConvertCSharpTypeToIosQuery.Int }, 
                                                                                                                                                                           new GetPropertiesQuery.Response { Name = "Boolean", Type = ConvertCSharpTypeToIosQuery.Boolean }, 
                                                                                                                                                                           new GetPropertiesQuery.Response { Name = "Type", Type = "MyEnum", Attributes = GetPropertiesQuery.Response.OfAttributes.IsEnum }, 
                                                                                                                                                                           new GetPropertiesQuery.Response { Name = "CreateDt", Type = ConvertCSharpTypeToIosQuery.Date, Attributes = GetPropertiesQuery.Response.OfAttributes.IsDateTime }, 
                                                                                                                                                                           new GetPropertiesQuery.Response { Name = "Ids", Type = ConvertCSharpTypeToIosQuery.String, Attributes = GetPropertiesQuery.Response.OfAttributes.IsArray }, 
                                                                                                                                                                   });
            mockQuery.Execute();
