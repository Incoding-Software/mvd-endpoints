...
// </auto-generated>
// ------------------------------------------------------------------------------
namespace Incoding.Endpoint.Operations.Code_Generate.Http
{
    using System.Linq;
    using System.Text;
    ...
    #line 1 "C:\Workspace\mvd-endpoints\src\MvdEndPoint.Domain\Operations\Code Generate\Http\Curl_Sample.tt"
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "14.0.0.0")]
    public partial class Curl_Sample : Curl_SampleBase
    {
#line hidden
        /// <summary>
        ...
        public virtual string TransformText()
        {
            ...
            #line 11 "C:\Workspace\mvd-endpoints\src\MvdEndPoint.Domain\Operations\Code Generate\Http\Curl_Sample.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(Verb));
            
            #line default
            #line hidden
            this.Write(" -H \"Content-Type: application/json; charset=UTF-8\" -H \"Host: ");
            ...
            #line default
            #line hidden
            this.Write("\" -H \"X-Requested-With: XMLHttpRequest\" -d \'");
...
/// <summary>
/// Access the Verb parameter of the template.
/// </summary>
private string Verb
{
    get
...
public virtual void Initialize()
{
    ...
    {
bool VerbValueAcquired = false;
if (this.Session.ContainsKey("Verb"))
{
    this._VerbField = ((string)(this.Session["Verb"]));
    VerbValueAcquired = true;
}
if ((VerbValueAcquired == false))
{
    object data = global::System.Runtime.Remoting.Messaging.CallContext.LogicalGetData("Verb");
    if ((data != null))
    {
        this._VerbField = ((string)(data));
    }
}
